...
<body class="font-sans text-gray-900 antialiased bg-[#F0F7FF]"> <!-- Fond très légèrement bleuté -->
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4">
            ...
            <a href="/" class="flex flex-col items-center no-underline group">
                ...
                <div class="flex items-center justify-center gap-3 mb-1">
                    ...
                    <span class="text-3xl font-extrabold tracking-tight">
                        <span style="color: #0D47A1;">Cabinet</span><span style="color: #1E88E5;">Médical</span>
                    </span>
                </div>
                
                <!-- Sous-titre stylé (Gris bleu, Majuscules, Espacé) -->
                <p class="text-slate-400 font-bold text-[10px] uppercase tracking-[0.15em] mt-1">
        ...
        <div class="w-full sm:max-w-xl px-10 py-12 bg-white shadow-[0_20px_50px_rgba(13,71,161,0.05)] border border-blue-50 overflow-hidden rounded-[2.5rem]">
            <div class="w-full">
                {{ $slot }}
            </div>
        </div>
