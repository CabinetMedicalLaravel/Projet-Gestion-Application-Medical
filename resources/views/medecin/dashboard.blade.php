<x-app-layout>
    <div class="py-8 bg-white min-h-screen font-sans text-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- EN-TÊTE -->
            <div class="mb-8 mt-4">
                <h1 class="text-3xl font-semibold text-gray-900">Bonjour, Dr. {{ Auth::user()->name }}</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-[#F8F7F4] rounded-2xl p-6">
                    ...
                    <p class="text-gray-500 text-sm">consultations prévues</p>
                </div>
                <div class="bg-[#F8F7F4] rounded-2xl p-6">
                    <p class="text-sm font-medium text-gray-600 mb-2">Patients total</p>
                    <p class="text-3xl font-semibold text-gray-900 mb-1">{{ $nbPatients ?? 0 }}</p>
                    <p class="text-gray-500 text-sm">dans votre liste</p>
                </div>
                <div class="bg-[#F8F7F4] rounded-2xl p-6">
                    ...
                    <p class="text-gray-500 text-sm">demandes à confirmer</p>
                </div>
                <div class="bg-[#F8F7F4] rounded-2xl p-6">
                    <p class="text-sm font-medium text-gray-600 mb-2">Ordonnances</p>
                    <p class="text-3xl font-semibold text-gray-900 mb-1">{{ $nbOrdonnances ?? 0 }}</p>
                    <p class="text-gray-500 text-sm">émises ce mois</p>
                </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="border border-gray-200 rounded-2xl p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="#" class="text-blue-600 text-sm font-medium hover:underline">Voir l'agenda</a>
                        </div>
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="flex items-center justify-between pb-6 border-b border-gray-100 last:border-0 last:pb-0">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-500 text-sm">{{ $rdv['motif'] }}</p>
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="text-center py-10 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                                    ...
                                    <p class="text-gray-500 font-medium">Aucun rendez-vous prévu aujourd'hui.</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-2xl p-6">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="text-lg font-semibold">Derniers patients consultés</h2>
                            <a href="#" class="text-blue-600 text-sm font-medium hover:underline">Voir tous</a>
                        </div>
                        <ul class="space-y-4">
                            @forelse ($derniersPatients ?? [] as $patient)
                                <li class="flex items-center justify-between pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 rounded-full bg-blue-100 text-blue-700 flex items-center justify-content-center font-semibold text-sm flex items-center justify-center">
                                            {{ strtoupper(substr($patient['nom'], 0, 1)) }}
                                        </div>
                                        <div>
                                            <p class="font-medium text-gray-900 text-sm">{{ $patient['nom'] }}</p>
                                            <p class="text-xs text-gray-500">{{ $patient['date_derniere_visite'] }}</p>
                                        </div>
                                    </div>
                                    <a href="#" class="text-xs text-blue-600 hover:underline">Dossier</a>
                                </li>
                            @empty
                                <p class="text-gray-500 text-sm text-center py-4">Aucun patient récent.</p>
                            @endforelse
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="border border-gray-200 rounded-2xl p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <a href="{{ url('/consultation/create/' . $patient->id) }}" class="block bg-[#F8F7F4] rounded-xl p-4 hover:bg-gray-100 transition">
                                ...
                                <h3 class="font-semibold text-gray-900 text-sm">Ordonnances</h3>
                                <p class="text-xs text-gray-500 mt-1">Rédiger / envoyer</p>
                            </a>
                            <a href="#" class="block bg-[#F8F7F4] rounded-xl p-4 hover:bg-gray-100 transition">
                                <div class="bg-white w-8 h-8 rounded-lg shadow-sm flex items-center justify-center mb-3">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Voir les dossiers</p>
                            </a>
                            <a href="#" class="block bg-[#F8F7F4] rounded-xl p-4 hover:bg-gray-100 transition">
                                <div class="bg-white w-8 h-8 rounded-lg shadow-sm flex items-center justify-center mb-3">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Activité du mois</p>
                            </a>
                        </div>
                    </div>
